...
If you have the Slack integration connected, requests can be extended directly in Slack:
...
If you have the Slack integration connected, requests can be closed directly in Slack:
