...
<img src="/images/cedar/cedar-actions-workflow.png" />
...
<Note>In versions >=v3.9.0 the requested target and role will be added automatically to your `~/.aws/config` file. To disable this function when requesting access include the `--skip-local-config-update` flag</Note>
