...
<Tabs>
  <Tab title="MacOS">
    ...
    ```bash
    curl -OL https://releases.commonfate.io/granted/v0.31.0/granted_0.31.0_darwin_arm64.tar.gz
    sudo tar -zxvf ./granted_0.31.0_darwin_arm64.tar.gz -C /usr/local/bin/
    ln -s /usr/local/bin/granted /usr/local/bin/assumego
    ```

    ## Reverting to an older version of Granted

    If you need to revert to an older version of Granted, you can manually downgrade using the following steps. First, make sure to uninstall your current version of granted. Replace "0.31.0" with the specific version you want to install.

    #### Using Homebrew
    ```
    brew uninstall granted
    brew tap-new $USER/local-tap
    brew extract --version=0.31.0 common-fate/granted/granted $USER/local-tap
    brew install granted@0.31.0
    ```
  ...
  <Tab title="Linux (Manual)">
    ...
    >
      ...
      <Tab title="arm64">
        ...
        ```bash
        curl -OL releases.commonfate.io/granted/v0.31.0/granted_0.31.0_linux_arm64.tar.gz
        sudo tar -zxvf ./granted_0.31.0_linux_arm64.tar.gz -C /usr/local/bin/
        ```
      ...
      <Tab title="i386">
        ...
        ```bash
        curl -OL releases.commonfate.io/granted/v0.31.0/granted_0.31.0_linux_i386.tar.gz
        sudo tar -zxvf ./granted_0.31.0_linux_i386.tar.gz -C /usr/local/bin/
        ```
  ...
  <Tab title="Windows">
    ...
    [Granted for Windows x86_64](https://releases.commonfate.io/granted/v0.31.0/granted_0.31.0_windows_x86_64.zip)

    [Granted for Windows arm64](https://releases.commonfate.io/granted/v0.31.0/granted_0.31.0_windows_arm64.zip)

    [Granted for Windows i386](https://releases.commonfate.io/granted/v0.31.0/granted_0.31.0_windows_i386.zip)
