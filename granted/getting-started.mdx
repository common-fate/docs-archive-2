...
<img height="200" src="/images/granted/cli-screenshot.png" />
...
<Tabs>
  <Tab title="MacOS">
    ...
    ```bash
    curl -OL https://releases.commonfate.io/granted/v0.27.5/granted_0.27.5_darwin_x86_64.tar.gz
    sudo tar -zxvf ./granted_0.27.5_darwin_x86_64.tar.gz -C /usr/local/bin/
    ...
    ```bash
    curl -OL https://releases.commonfate.io/granted/v0.27.5/granted_0.27.5_darwin_arm64.tar.gz
    sudo tar -zxvf ./granted_0.27.5_darwin_arm64.tar.gz -C /usr/local/bin/
    ln -s /usr/local/bin/granted /usr/local/bin/assumego
    ```

    ## Reverting to an older version of Granted

    If you need to revert to an older version of Granted, you can manually downgrade using the following steps. First, make sure to uninstall your current version of granted. Replace "0.27.5" with the specific version you want to install.

    #### Using Homebrew
    ```
    brew uninstall granted
    brew tap-new $USER/local-tap
    brew extract --version=0.27.5 common-fate/granted/granted $USER/local-tap
    brew install granted@0.27.5
    ```
  ...
  <Tab title="Linux (Manual)">
    ...
    >
      ...
      <Tab title="x86_64">
        ...
        ```bash
        curl -OL releases.commonfate.io/granted/v0.27.5/granted_0.27.5_linux_x86_64.tar.gz
        sudo tar -zxvf ./granted_0.27.5_linux_x86_64.tar.gz -C /usr/local/bin/
        ```
      ...
      <Tab title="arm64">
        ...
        ```bash
        curl -OL releases.commonfate.io/granted/v0.27.5/granted_0.27.5_linux_arm64.tar.gz
        sudo tar -zxvf ./granted_0.27.5_linux_arm64.tar.gz -C /usr/local/bin/
        ```
      ...
      <Tab title="i386">
        ...
        ```bash
        curl -OL releases.commonfate.io/granted/v0.27.5/granted_0.27.5_linux_i386.tar.gz
        sudo tar -zxvf ./granted_0.27.5_linux_i386.tar.gz -C /usr/local/bin/
        ```
  ...
  <Tab title="Windows">
    ...
    [Granted for Windows x86_64](https://releases.commonfate.io/granted/v0.27.5/granted_0.27.5_windows_x86_64.zip)

    [Granted for Windows arm64](https://releases.commonfate.io/granted/v0.27.5/granted_0.27.5_windows_arm64.zip)

    [Granted for Windows i386](https://releases.commonfate.io/granted/v0.27.5/granted_0.27.5_windows_i386.zip)
    ...
    <img height="200" src="/images/granted/git-bash-pseudo-console.png" />
