...
The least privilege analisis feature has been removed, if you had the feature enabled, you should remove references to the variables in your infrastructure.
